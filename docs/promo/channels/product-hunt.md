...
```text
Working flight decks (taxi, take off, land back aboard), a Training Ground level that teaches all of it, 100 medals, 3-star theater ratings, and a shareable battle report card
```
