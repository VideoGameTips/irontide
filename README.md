...
- **100 枚勋章（击舰能手 I–XII 分级 + 核弹/神风/布雷/声呐/损管等专项）+ 每个战区三星评价 + 可存成 PNG 的战报卡片**
- **快速战斗**和 **7 张沙盒地图**，想打一架就打一架
- **训练场**：一个专门用来学的关卡，26 步把开船、装炮、开飞机、开坦克、上岸、建造从头教一遍，随时可以再来一次
...
| ⏸ **菜单即暂停** | 打开海港/建造/地图/聊天时战斗冻结，慢慢读不会被击沉。**军械库例外**：默认边打边买，想要它也暂停就在 K 设置面板打开「进军械库时暂停战斗」 |
| 🎚 **难度选择** | 🙂简单 / 😐普通 / 😈困难，新手默认简单（伤害减半、船体 +50%） |
| 🛒 **商店分类** | 121 个物品分成 5 个页签，⭐ 标出新手推荐，贵重装备默认折叠 |
| 🎖 **成就体系** | 100 枚勋章（含击舰能手 I–XII 分级与核弹/神风/损管等专项）、战区三星评价、结算战报卡片可存成 PNG |
